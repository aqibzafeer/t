    ...
    <section className="max-w-7xl mx-auto px-6 py-16">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Discover our handpicked teas made with love and tradition. Each blend
          offers a unique flavor to refresh your body and mind.
        </p>
      </div>
          ...
          >
            ...
            <div className="flex-1 p-6 flex flex-col justify-between">
              ...
              <div className="mt-6">
                <Link
                  href={`/products/${p.id}`}
                  className="inline-block bg-red-800 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-emerald-700 transition-colors"
                >
                  View Details
                </Link>
              </div>
